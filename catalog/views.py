...
def home(request):
    if request.method == "POST":
        ...
        Product.objects.create(product_name=product_name, descriptions=descriptions, picture=picture,
                               category=category_inst, price=price, date_create=date_create, date_update=date_update)
